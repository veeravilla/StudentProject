 ...
 *         &lt;element name="providers" type="{http://www.test.bank.com/}Provider" maxOccurs="unbounded" minOccurs="0"/>
...
public class CreditResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public CreditResponse(final int noOfAccounts, final int creditScore, final List<Provider> providers, final String zipcode, final Status status, final Address address) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Provider> theProviders;
            theProviders = this.getProviders();
            strategy.appendField(locator, this, "providers", buffer, theProviders);
        }
        {
            String theZipcode;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<Provider> lhsProviders;
            lhsProviders = this.getProviders();
            List<Provider> rhsProviders;
            rhsProviders = that.getProviders();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "providers", lhsProviders), LocatorUtils.property(thatLocator, "providers", rhsProviders), lhsProviders, rhsProviders)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<Provider> theProviders;
            theProviders = this.getProviders();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "providers", theProviders), currentHashCode, theProviders);
        }
        {
            String theZipcode;
            theZipcode = this.getZipcode();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CreditResponse) {
            ...
            if ((this.providers!= null)&&(!this.providers.isEmpty())) {
                List<Provider> sourceProviders;
                sourceProviders = this.getProviders();
                @SuppressWarnings("unchecked")
                List<Provider> copyProviders = ((List<Provider> ) strategy.copy(LocatorUtils.property(locator, "providers", sourceProviders), sourceProviders));
                copy.providers = null;
                List<Provider> uniqueProvidersl = copy.getProviders();
                uniqueProvidersl.addAll(copyProviders);
            } else {
                copy.providers = null;
            }
